...
const Trending = () =>{
    return(
        <div>
            <Container>
                <br/>
                <h1 className='text-white'>Tranding Movie</h1>
                <br/>
                <Row>
                    <Col md={4} className='moveWraper' id='trending'>
                    ...
                    <Col md={4} className='moveWraper'>
                        <Card className="bg-white moveImages" >
                            ...
                            <div className='bg-dark'>
                                <div className='p-2 m-1 text-white'>
                                <Card.Title className='text-center'>The Secret Life of Pets</Card.Title>
                                <Card.Text className='text-left'>
                                    This is a wider card with supporting text below as a natura This content is a little bit longer.
                                </Card.Text>
                                <Card.Text className='text-left'>Last updated 3 mins ago</Card.Text>        
                    ...
                    <Col md={4} className='moveWraper'>
                        <Card className="bg-white moveImages" >
                            ...
                            <div className='bg-dark'>
                                <div className='p-2 m-1 text-white'>
                                <Card.Title className='text-center'>The Secret Life of Pets 2</Card.Title>
                                <Card.Text className='text-left'>
                                    This is a wider card with supporting text below as a natura This content is a little bit longer.
                                </Card.Text>
                                <Card.Text className='text-left'>Last updated 3 mins ago</Card.Text>        
